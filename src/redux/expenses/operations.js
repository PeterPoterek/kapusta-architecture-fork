...
axios.defaults.baseURL = "https://tomek-backend-fork.onrender.com/";
// axios.defaults.baseURL = "http://localhost:8000/";

const getExpenseStats = createAsyncThunk("expenses/getExpensesStats", async (data, thunkAPI) => {
  try {
...
const setNewExpense = createAsyncThunk("expenses/setNewExpense", async (data, thunkAPI) => {
...
const deleteExpense = createAsyncThunk("expenses/deleteExpense", async (transactionId, thunkAPI) => {
  try {
